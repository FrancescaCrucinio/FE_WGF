...
\begin{frame}{PET}
The reconstruction of a cross-section of the brain (Figure (a)) from the data image provided by PET scanners (Figure (b)) is described by a 2D Fredholm integral equation of the first kind.
