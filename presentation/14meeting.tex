...
\begin{enumerate}
    ...
    \item $K$ bounded and bounded away from 0, Lipschitz continuous with Lipschitz continuous gradient and $\lambda$-concave in $x$, uniformly in $y$, for some $\lambda>0$ for all $y\in\Y$.
\end{enumerate}
\end{frame}
